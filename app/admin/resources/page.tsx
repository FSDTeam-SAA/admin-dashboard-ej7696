...
export default function ResourcesAdminPage() {
  ...
  const handleSaveProduct = () => {
    if (!productForm.categoryId || !productForm.code.trim() || !productForm.title.trim()) {
    ...
    payload.append("originalPrice", String(toNumberOrZero(productForm.originalPrice)));
    payload.append(
      "upgradeDiscountPrice",
      String(toNumberOrZero(productForm.upgradeDiscountPrice))
    );
    payload.append("currency", productForm.currency.trim().toUpperCase() || "USD");
  ...
  const savingProduct = createProductMutation.isLoading || updateProductMutation.isLoading;
            ...
            <tbody>
              {(loadingProducts ? [] : products).map((product: any) => (
                <tr key={product._id} className="border-b border-slate-100">
                  ...
                  <td className="py-2">${Number(product.price || 0).toFixed(2)}</td>
                  <td className="py-2">
                    <Button
                      variant="outline"
                      size="sm"
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProductForm((prev) => ({ ...prev, shortDescription: e.target.value }))
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProductForm((prev) => ({ ...prev, coverImageUrl: e.target.value }))
                }
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProductForm((prev) => ({ ...prev, contentUrl: e.target.value }))
                }
            ...
            <div className="space-y-2">
              ...
              />
              {contentFile && (
                <p className="text-xs text-slate-500">Selected: {contentFile.name}</p>
              )}
            </div>
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setProductForm((prev) => ({ ...prev, upgradeDiscountPrice: e.target.value }))
                  }
                />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setProductForm((prev) => ({ ...prev, bundleIncludes: e.target.value }))
                }
              />
            </div>
        ...
        <AlertDialogContent className="bg-white rounded-2xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-medium text-slate-800">{deleteTarget?.title || "this product"}</span>
